 ...
 ?>
                            ...
                            <div class="mws-panel grid_8 mws-collapsible">
                                <div class="mws-panel-header">
                                    <span><i class="icon-user"></i> Users </span>
                                </div>
...
<?php echo form_open('admin/delete_users', 'id="frm1' . $list['id'] . '"'); ?>
                                                <a href="#" class="btn btn-small"><i class="icon-search"></i></a>
                                                <a href="<?php echo base_url(); ?>index.php/admin/add_users/<?php echo $list['id']; ?>" class="btn btn-small"><i class="icon-pencil"></i></a>
                                                <?php
...
<?php } ?>
                                        ...
                                        <div class="mws-panel grid_8">
                                            <div class="mws-panel-header">
                                                <span><i class="icon-pencil"></i> User Details </span>
                                            </div>
                                            <div class="mws-panel-body no-padding">
<?php echo form_open('admin/save_users', 'id="form1" class="mws-form"'); ?>
                                        ...
                                        <?php
                                        echo form_hidden('id', $userData['0']['id']);
                                        echo form_input('companyName', $userData['0']['companyName'], 'class="medium"');
                                        ?>
                                    </div>
                                </div>

                                                  <div class="mws-form-row">
                                                <label class="mws-form-label"> Contact Name    </label>
                                                <div class="mws-form-item">
                                        <?php
                                        echo form_input('contactName', $userData['0']['contactName'], 'class="medium"');
                                        ?>
                                    </div>
                                </div>

                                                  <div class="mws-form-row">
                                                <label class="mws-form-label"> Account    </label>
                                                <div class="mws-form-item">
                                        <?php
                                        echo form_input('account', $userData['0']['account'], 'class="medium"');
                                        ?>
                                    </div>
                                </div>
                                         ...
                                         <div class="mws-form-row">
                                                ...
                                                <div class="mws-form-item">
                                        <?php
                                        echo form_textarea('address1', $userData['0']['address1'], 'class="medium"');
                                        ?>
                                    </div>
                                </div>
                                                ...
                                                <div class="mws-form-item">
                                        <?php
                                        echo form_input('postal_code', $userData['0']['postal_code'], 'class="medium"');
                                        ?>
                                    </div>
                                </div>
                                            ...
                                            <div class="mws-form-row">
                                                ...
                                                <div class="mws-form-item">
                                        <?php
                                        echo form_input('postal_code', $userData['0']['city'], 'class="medium"');
                                        ?>
                                    </div>
                                </div>
                                                ...
                                                <div class="mws-form-item">
                                        <?php
                                        echo form_input('phone', $userData['0']['phone'], 'class="medium"');
                                        ?>
                                    </div>
                                </div>
                                                ...
                                                <div class="mws-form-item">
                                        <?php
                                        echo form_input('email', $userData['0']['email'], 'class="medium"');
                                        ?>
                                    </div>
                                </div>
                                                     ...
                                                     <div class="mws-form-row">
                                                <label class="mws-form-label">  Offer  </label>
                                                <div class="mws-form-item">
                                        <?php
                                        echo form_input('offer', $userData['0']['offer'], 'class="medium"');
                                        ?>
                                    </div>
                                </div>
...
<?php echo form_close(); ?>
                            ...
                            <!-- Footer -->
                            <div id="mws-footer">
                                                                            	Copyright MHEL 2013. All Rights Reserved.
                            </div>
