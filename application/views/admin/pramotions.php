                    ...
                    ?>
                            ...
                            <div class="mws-panel grid_8 mws-collapsible">
                                <div class="mws-panel-header">
                                    <span><i class="icon-newspaper"></i>  Promotions  </span>
                                </div>
...
<?php echo form_open('admin/delete_pramotions', 'id="frm1' . $list['id'] . '"'); ?>
                                                <a href="#" class="btn btn-small"><i class="icon-search"></i></a>
                                                <a href="<?php echo base_url(); ?>index.php/admin/add_pramotions/<?php echo $list['id']; ?>" class="btn btn-small"><i class="icon-pencil"></i></a>
                                                <?php
...
<?php } ?>
                                        ...
                                        <div class="mws-panel grid_8">
                                            <div class="mws-panel-header">
                                                <span><i class="icon-pencil"></i> Promotion</span>
                                            </div>
                                            <div class="mws-panel-body no-padding">
<?php echo form_open('admin/save_pramotions', 'id="form1" class="mws-form"'); ?>
                                        ...
                                        <?php
                                        echo form_hidden('id', $pramoData['0']['id']);
                                        echo form_input('title', $pramoData['0']['title'], 'class="medium"');
                                        ?>
                                    </div>
                                </div>
                                ...
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        <?php
                                        echo form_textarea('description', $pramoData['0']['description'], 'class="medium"');
                                        ?>
                                    </div>
                                </div>
                                ...
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        ...
                                        echo form_dropdown('stat', $options, $pramoData['0']['stat'], 'class="fx-select"');
                                        ?>
                                    </div>
                                </div>
                                ...
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        <?php
                                       echo form_input('date', $pramoData['0']['date'], 'class="medium" id="date"');
                                        ?>
                                    </div>
                                </div>
