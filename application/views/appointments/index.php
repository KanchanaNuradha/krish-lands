...
<div class="container">
    <div class="mws-panel grid_10" style="margin: 0">
        <div class="mws-panel-header">
            <span style="float: left"><i class="icon-list"></i> Appointments 
            </span>
        </div>
    </div>
                ...
                <tbody>
                    <?php foreach ($appointments as $app) { ?>
                        <tr>
                            ...
                            <td> <?php echo $app['cus_id'] ?></td>
                            <td> <?php echo $app['land_id'] ?></td>
                            <td> <?php echo $app['note'] ?></td>
                            <td> <?php echo $app['date'] ?></td>
                            <td> <?php echo $app['time'] ?></td>
                            <td> <?php echo $app['contact_no'] ?></td>
                            <td> <?php echo $app['date'] ?></td>
                            <td> <span class="btn-group">
                                    <?php echo form_open('findtalents/delete_talent', 'id="frm1' . $app['id'] . '"'); ?>                              
                                    
                                    <?php
                                    echo form_hidden('id', $app['id']);
                                    echo '<a href="#" class="btn btn-small" onclick="confirm_delete(' . $app['id'] . ')" ><i class="icon-trash"></i></a>';
                                    echo form_close();
                                    ?>
                                </span></td>
                        </tr>
