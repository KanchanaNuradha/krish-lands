...
<div class="container">
    <div class="mws-panel grid_10" style="margin: 0">
        <div class="mws-panel-header">
            <span style="float: left"><i class="icon-globe"></i> Locations  

            </span>
            <span class="btn-group"> 
                <a href="<?php echo base_url(); ?>index.php/settings/add_location" class="btn btn-success" style="float: right">Add Location <i class="icon-plus-sign"></i></a>
            </span> 
        </div>
    </div>
                    ...
                    <?php foreach ($locations as $category) { ?>
                        <tr>
                            ...
                            <td> <span class="btn-group">
                                    <?php echo form_open('settings/delete_location', 'id="frm1' . $category['id'] . '"'); ?>
                                    <?php if ($category['stat'] == 1) { ?>
                                        <a href="<?php echo base_url(); ?>index.php/settings/unpublish_location/<?php echo $category['id']; ?>" class="btn btn-small"><i class="icon-unlock " style="color: green" ></i></a>
                                    <?php } else { ?>
                                        <a href="<?php echo base_url(); ?>index.php/settings/publish_location/<?php echo $category['id']; ?>" class="btn btn-small"><i class="icon-lock" style="color: red"></i></a>
                                    <?php } ?>                               
                                    <a href="<?php echo base_url(); ?>index.php/settings/add_location/<?php echo $category['id']; ?>" class="btn btn-small"><i class="icon-pencil"></i></a>
                                    <?php
