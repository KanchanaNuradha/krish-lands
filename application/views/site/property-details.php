    ...
    <body>
        ...
        <div class="main-content">
                ...
                <div class="container">
                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img class="img-responsive" src="<?php echo base_url(); ?>site/images/view-1.jpg" alt="" />
                                </div>
                                <div class="item">
                                    <img class="img-responsive" src="<?php echo base_url(); ?>site/images/view-2.jpg" alt="" />
                                </div>
                                <div class="item">
                                    <img class="img-responsive" src="<?php echo base_url(); ?>site/images/view-3.jpg" alt="" />
                                </div>
                            </div>
                    ...
                    <div class="col-md-6 ins-details">
                        ...
                        <div class="span span1">
                            <p class="left">Situated Location</p>
                            <p class="right">: Kaluthara</p>
                            <div class="clearfix"></div>
                        </div>
                        <div class="span span2">
                            <p class="left">Number of land blocks remaining</p>
                            <p class="right">: 5</p>
                            <div class="clearfix"></div>
                        </div>
                        <div class="span span1">
                        ...
                        <div class="span span4">
                            <p class="left">Size of Land blocks</p>
            ...
            <div class="wthree-related-properties text-center">
                <div class="container">
                    <h3 class="w3l-heading">Related Lands</h3>
                    <div class="col-md-3 w3-related-property">
                        <a href="#"><figure><img class="img-responsive" src="<?php echo base_url(); ?>site/images/related-property-img1.jpg" alt="" /></figure></a>
                        <a href="#">Property Details</a>
                    </div>
                    <div class="col-md-3 w3-related-property">
                        <a href="#"><figure><img class="img-responsive" src="<?php echo base_url(); ?>site/images/related-property-img2.jpg" alt="" /></figure></a>
                        <a href="#">Property Details</a>
                    </div>
                    <div class="col-md-3 w3-related-property">
                        <a href="#"><figure><img class="img-responsive" src="<?php echo base_url(); ?>site/images/related-property-img3.jpg" alt="" /></figure></a>
                        <a href="#">Property Details</a>
                    </div>
                    <div class="col-md-3 w3-related-property">
                        <a href="#"><figure><img class="img-responsive" src="<?php echo base_url(); ?>site/images/related-property-img4.jpg" alt="" /></figure></a>
                        <a href="#">Property Details</a>
                    </div>
                    <div class="clearfix"></div>
                </div>
