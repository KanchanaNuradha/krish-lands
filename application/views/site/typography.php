...
<link href="http://localhost/krish-lands/site/css/bootstrap.css" type="text/css" rel="stylesheet" media="all"><!-- Bootstrap stylesheet -->
<link href="http://localhost/krish-lands/site/css/style.css" rel="stylesheet" type="text/css" media="all" /><!-- stylesheet -->
<link href="http://localhost/krish-lands/site/css/font-awesome.min.css" rel="stylesheet" type="text/css" media="all" /><!-- fontawesome -->  
<!-- meta tags -->
...
<!--//fonts-->	
<script type="text/javascript" src="http://localhost/krish-lands/site/js/jquery-2.1.4.min.js"></script><!-- Required-js -->
<script src="http://localhost/krish-lands/site/js/bootstrap.min.js"></script><!-- jQuery (necessary for Bootstrap's JavaScript plugins) -->
<script type="text/javascript" src="http://localhost/krish-lands/site/js/numscroller-1.0.js"></script>
<!-- here stars scrolling icon -->
			...
			<script type="text/javascript" src="http://localhost/krish-lands/site/js/move-top.js"></script>
			<script type="text/javascript" src="http://localhost/krish-lands/site/js/easing.js"></script>
			<script type="text/javascript">
...
<body>
	...
	<header>
		<div class="container">
			...
			<script src="http://localhost/krish-lands/js/nav.js"></script><!-- nav-js --> 
			<!-- //nav -->
		</div>
	</header>
	<!-- //header -->
