...
function gethead($css, $message, $num, $userdata = null, $main_menu, $prof_inf = null, $title = null) { ?>
    ...
    <!--[if gt IE 8]><!--><html lang="en"><!--<![endif]-->
        <head>
            ...
            <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>admin/custom-plugins/wizard/wizard.css" media="screen">
            ...
            <title> Mobile Application Administrator </title>         
        ...
        <body>
                ...
                <div id="mws-user-tools" class="clearfix">
                    <div id="mws-user-info" class="mws-inset">
                        ...
                        <div id="mws-user-photo">
                            <a href="<?php echo base_url(); ?>index.php/agent/user_profile" > 
                                <?php if ($userdata['image']) { ?>
                                    <img src="<?php echo base_url(); ?>/files/prof/thumb/<?php echo $userdata['image'] ?>" > 
                                <?php } else { ?>
                                    <img src="<?php echo base_url(); ?>/files/prof/thumb/default.png" >
                                <?php } ?>
                            </a>
                        </div>
                        ...
                        <?php if (isset($userdata['id'])) {
                            ...
                            <div id="mws-user-functions">
                                ...
                                <ul>                          
                                    <li> <?php echo anchor('agent/change_password', 'Change Password'); ?>  </li>
            ...
            <div id="mws-wrapper">
                ...
                function footer() {
                    ...
                    <div id="mws-footer">
                        Copyright KRISH LANDS 2017. All Rights Reserved.
                    </div>
    ...
    <!--            <script src="<?php echo base_url(); ?>admin/plugins/flot/jquery.flot.min.js"></script>
            <script src="<?php echo base_url(); ?>admin/plugins/flot/plugins/jquery.flot.tooltip.min.js"></script>
            <script src="<?php echo base_url(); ?>admin/plugins/flot/plugins/jquery.flot.pie.min.js"></script>
            <script src="<?php echo base_url(); ?>admin/plugins/flot/plugins/jquery.flot.stack.min.js"></script>
            <script src="<?php echo base_url(); ?>admin/plugins/flot/plugins/jquery.flot.resize.min.js"></script>
            ...
            <script src="<?php echo base_url(); ?>admin/custom-plugins/wizard/wizard.min.js"></script>-->
            ...
            <script src="<?php echo base_url(); ?>admin/js/demo/demo.dashboard.js"></script>
